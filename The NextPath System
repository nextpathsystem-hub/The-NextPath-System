    ...
    <div>
      ...
      <div class="about-stats">
        <div class="stat-box">
          ...
          <span class="stat-label">De la population RDC a moins de 25 ans</span>
        </div>
        <div class="stat-box">
          <span class="stat-number">20K</span>
          <span class="stat-label">Jeunes visés d'ici 2028</span>
        </div>
        <div class="stat-box">
          <span class="stat-number">15–25</span>
          <span class="stat-label">Ans — tranche d'âge prioritaire</span>
        </div>
        <div class="stat-box">
  ...
  <div class="programme-inner">
    <div>
      ...
      <div class="programme-modules">
        ...
        <div style="margin-top:20px;padding:16px 20px;background:rgba(201,168,76,0.08);border:1px solid rgba(201,168,76,0.3);border-radius:4px;">
          <div style="font-size:11px;font-weight:500;letter-spacing:.1em;text-transform:uppercase;color:var(--gold);margin-bottom:8px;">En tant que membre tu bénéficies de</div>
          <div style="display:flex;flex-direction:column;gap:6px;font-size:13px;color:var(--cream);">
            <div>✦ Sessions de groupe hebdomadaires en live</div>
            <div>✦ Accès au groupe WhatsApp privé NextPath</div>
            <div>✦ Exercices et outils pratiques entre les sessions</div>
            <div>✦ Suivi personnalisé par Grace Kabondo</div>
            <div>✦ Communauté de jeunes africains engagés</div>
          </div>
        </div>
      </div>
    </div>
...
<section class="test-section" id="test">
  <div class="test-inner">
    ...
    <a href="https://docs.google.com/forms/d/e/1FAIpQLSdvA440a9h65ZcFT4XXJUoPJBelQbqrmUgU27X1pDnX6I-XkQ/viewform?usp=header" class="btn-primary" target="_blank">Passer le test gratuitement</a>
  </div>
</section>
    ...
    <div class="grace-visual">
      ...
      <div style="display:flex;flex-direction:column;gap:12px;margin-top:32px;">
        <div style="padding:16px 20px;border:1px solid rgba(201,168,76,0.15);border-radius:2px;">
          ...
          <div style="font-size:14px;color:var(--cream);line-height:1.6;">Master Sciences du Médicament<br><span style="font-size:12px;color:rgba(245,240,232,0.5);">Nantes Université · France</span></div>
        </div>
...
<section class="contact" id="contact">
  <div class="contact-inner">
    ...
    <div class="social-links">
      ...
      <a href="https://wa.me/33766131603" target="_blank" class="social-link">
        <span class="platform">WhatsApp</span>
        <span>+33 7 66 13 16 03</span>
      </a>
    </div>
...
<footer>
  ...
  <div>Fondé par Grace Kabondo · France</div>
</footer>
